...
# For making this a runnable .py file
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            losses[iter_num, 0] = loss_all['rpn_out_class_loss']
            losses[iter_num, 1] = loss_all['rpn_out_regress_loss']
            
            losses[iter_num, 2] = loss_all['dense_class_{}_loss'.format(len(classes_count))]
            losses[iter_num, 3] = loss_all['dense_regress_{}_loss'.format(len(classes_count))]
            losses[iter_num, 4] = loss_all['dense_class_{}_accuracy'.format(len(classes_count))]
